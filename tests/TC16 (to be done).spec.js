...
// const product = 'GP-Manual-Order-155';
...
// test.skip('Verify Record Serial For Final Item', async ({page}) => {
...
//   await scanVerify.scanInput(product);
//   await scanVerify.verifyRecordSerialForFinalItem(product);
//   console.log('TC 16 Successfully Passed');
// });
